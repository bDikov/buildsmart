...
public partial class PlaceBidViewModel : ObservableObject
{
    ...
    private async Task SubmitBidAsync()
    {
        ...
        {
            await AppServiceLocator.Alerts.DisplayAlert("Error", "Invalid Job ID.", "OK");
            return;
        }

        if (BidItems.Count == 0)
        {
            await AppServiceLocator.Alerts.DisplayAlert("Validation", "No tasks available to bid on.", "OK");
            return;
        }
        ...
        {
            await AppServiceLocator.Alerts.DisplayAlert("Validation", "Please enter a valid price for all tasks.", "OK");
            return;
        }
        ...
        try
        {
            ...
            {
                await AppServiceLocator.Alerts.DisplayAlert("Error", "Could not verify your Tradesman Profile.", "OK");
                return;
            }
            ...
            await AppServiceLocator.Alerts.DisplayAlert("Success", "Your bid has been placed successfully!", "OK");
