    ...
    public static async Task SeedLandingPagesAsync(this AppDbContext context)
    {
        ...
        var defaultPages = new[]
        {
            ...
            new LandingPageContent
            {
                ...
                HeroImageUrl = "/images/interio/hero-bathroom.webp",
                HeroVideoUrl = "",
                MediaGalleryJson = "[{\"url\":\"/images/interio/bathroom-1.jpg\",\"type\":\"image\",\"captionBg\":\"Голямоформатен гранитогрес\",\"captionEn\":\"Porcelain Tiles\",\"order\":1}]",
            ...
            new LandingPageContent
            {
                ...
                HeroImageUrl = "/images/interio/hero-finishing.webp",
                HeroVideoUrl = "",
                MediaGalleryJson = "[]",
            ...
            new LandingPageContent
            {
                ...
                HeroImageUrl = "/images/interio/hero-mep.webp",
                HeroVideoUrl = "",
                MediaGalleryJson = "[]",
